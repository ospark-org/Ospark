...
class Trainer:
    ...
    def __init__(self,
        ...
        self._save_path        = save_path or "./weights.json"
    ...
    def will_save(self, epoch_number: int) -> bool:
        if self.save_times is None:
            return False
        return (epoch_number + 1) % int(self.epoch_number / self.save_times) == 0
    ...
    def save(self, weights: dict, path: Optional[str]=None) -> NoReturn:
