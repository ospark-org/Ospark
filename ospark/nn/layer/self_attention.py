...
from . import Layer
from ospark.nn.component.normalization import Normalization, LayerNormalization
...
class SelfAttention(Layer):
    ...
    def model(self, input_data: tf.Tensor, mask: tf.Tensor=None) -> tf.Tensor:
        main_output = self.attention_layer(input_data, mask)
    ...
    def attention_layer(self, input_data: tf.Tensor, mask: tf.Tensor=None) -> tf.Tensor:
    ...
    def __call__(self, mask: tf.Tensor=None) -> tf.Tensor:
