...
class FOTSTrainer(Trainer):
    ...
    def start(self) -> NoReturn:
        ...
        for i in range(self.epoch_number):
            ...
            for batch, (train_data, target_maps, target_words, bbox_points) in enumerate(self.data_generator):
                ...
                if batch % 100 == 0:
                    print(detection_loss, recognition_loss)

                detection_loss_value += detection_loss
    ...
    def detection_part(self,
        ...
        with tf.GradientTape() as detection_tape:
            ...
            gradients   = self.calculate_gradient(tape=detection_tape, loss_value=loss_value, training_variable=self.detection_variables)
        del detection_tape
    ...
    def recognition_part(self,
        ...
        self.optimizer.apply_gradients(zip(accumulation_gradients, self.recognition_variables))
