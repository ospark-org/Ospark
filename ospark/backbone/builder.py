...
def resnet50(trainable: bool, catch_output: bool) -> ResnetBackbone:
...
def resnet101(trainable: bool, catch_output: bool) -> ResnetBackbone:
...
def resnet152(trainable: bool, catch_output: bool) -> ResnetBackbone:
...
def resnet18(trainable: bool, catch_output: bool) -> ResnetBackbone:
...
def resnet34(trainable: bool, catch_output: bool) -> ResnetBackbone:
    cells_number   = [3, 4, 6, 3]
    main_channels  = [64, 128, 256, 512]
    input_channels = [64, 64, 128, 256]
    scale_rate     = 1
